...
| File | Description |
|---|---|
| `uefi-bootloader-password.c` | Main UEFI application source code |
...
2. Copy the generated `EXPECTED_HASH` array into
   `uefi-bootloader-password.c`, replacing the existing placeholder.
...
This produces `uefi-bootloader-password.efi` in the project directory.
...
cp uefi-bootloader-password.efi test_disk/EFI/BOOT/BOOTX64.EFI
